...
// usage: prog training_data_file testing_data_file generatedModel(.xml)
...
#define ATTRIBUTES_PER_SAMPLE 30
...
{
	//ofstream outfile;
    //outfile.open("classification_result30.txt", std::ofstream::out);  
	...
	//The third input is the number of attributes
	//ATTRIBUTES_PER_SAMPLE=atoi(argv[3]);
            ...
            read_data_from_csv(argv[2], testing_data, testing_classifications, NUMBER_OF_TESTING_SAMPLES))
    {
		...
		//instead of traning the model, a saved model is being used
        rtree->train(training_data, CV_ROW_SAMPLE, training_classifications,
                     Mat(), Mat(), var_type, Mat(), params);
		
		char * model_name=argv[3];
		rtree->save(model_name);
		//CvRTrees* rtree = new CvRTrees;
		//rtree->load("RandomForestModel10.xml");
